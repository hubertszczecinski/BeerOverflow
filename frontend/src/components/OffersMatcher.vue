 <script setup>
  ...
  function barColor(value) {
    if (!selectedProduct.value) return 'bg-gray-300'
  ...
  {{ answer }}</pre>
        ...
        <div class="border rounded bg-white p-4 space-y-4">
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-1">
              ...
              <div class="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                <div
                  ...
                  :class="barColor(match.cost)"
                  :style="{ width: (selectedProduct ? formatPercent(match.cost) : 0) + '%' }"
                ></div>
              </div>
            </div>
            ...
            <div class="space-y-1">
              <div class="flex items-center justify-between text-sm">
                <span class="text-gray-700">Length</span>
                <span class="text-gray-900">
              ...
              <div class="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                <div
                  class="h-3 transition-all duration-500"
                  :class="barColor(match.length)"
                  :style="{ width: (selectedProduct ? formatPercent(match.length) : 0) + '%' }"
                ></div>
              </div>
            </div>
            ...
            <div class="space-y-1">
              <div class="flex items-center justify-between text-sm">
                <span class="text-gray-700">Comfort</span>
                <span class="text-gray-900">
              ...
              <div class="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                <div
                  class="h-3 transition-all duration-500"
                  :class="barColor(match.comfort)"
                  :style="{ width: (selectedProduct ? formatPercent(match.comfort) : 0) + '%' }"
                ></div>
              </div>
            </div>
